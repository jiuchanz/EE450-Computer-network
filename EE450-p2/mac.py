    ...
    while True:
        try:
            ...
            for item in input_ready:
                        ...
                        if DST in idsKnown:
                            ...
                            for x in range(0,len(ips)):
                                ...
                                if UDP_IP==myIP and UDP_PORT==int(myPORT):
                                    continue
                                data="SRC:"+myPeerName+";DST:"+DST+";PNUM:3;HCT:9;MNUM:"+format(MNUMCount, '03d')+";VL:"+VLstr+";MESG:"+MESSAGE[8:]
                ...
                if item == our_socket:
                    data, addr = our_socket.recvfrom(4096)
                    print("Got message %s" % data.decode('utf-8'))
                    ...
                    MESG=data.decode('utf-8').split(";")[6].split(":")[1]
                    VL=data.decode('utf-8').split(";")[5].split(":")[1].split(",")
                    VLstr=data.decode('utf-8').split(";")[5].split(":")[1]
                    ...
                    if PNUM=="4" or PNUM=="8":
                        ...
                        MESSAGE="SRC:"+DST+";DST:"+SRC+";PNUM:8;HCT:1;MNUM:"+MNUM+";VL:"+VLstr+";MESG:ACK"
                        our_socket.sendto(MESSAGE.encode('utf-8'),addr)
                    elif PNUM=="3" :
                        MESSAGE="SRC:"+DST+";DST:"+SRC+";PNUM:4;HCT:1;MNUM:"+MNUM+";VL:"+VLstr+";MESG:ACK"
                        print(UDP_IP,UDP_PORT)
                        print(MESSAGE)
                        our_socket.sendto(MESSAGE.encode('utf-8'),addr)
                        if DST!=myPeerName: 
